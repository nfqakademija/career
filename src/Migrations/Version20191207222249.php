 ...
 */
final class Version20191207222249 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_answer DROP INDEX UNIQ_BF8F5118F8DFB141, ADD INDEX IDX_BF8F5118F8DFB141 (fk_choice_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_answer DROP INDEX IDX_BF8F5118F8DFB141, ADD UNIQUE INDEX UNIQ_BF8F5118F8DFB141 (fk_choice_id)');
