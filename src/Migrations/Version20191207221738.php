 ...
 */
final class Version20191207221738 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_answer DROP INDEX UNIQ_BF8F5118F0FD4621, ADD INDEX IDX_BF8F5118F0FD4621 (fk_criteria_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_answer DROP INDEX IDX_BF8F5118F0FD4621, ADD UNIQUE INDEX UNIQ_BF8F5118F0FD4621 (fk_criteria_id)');
