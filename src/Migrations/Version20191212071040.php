...
final class Version20191212071040 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE career_profile ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME DEFAULT NULL, DROP criteria_count');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE career_profile ADD criteria_count INT DEFAULT NULL, DROP created_at, DROP updated_at');
