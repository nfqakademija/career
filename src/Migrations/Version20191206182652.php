 ...
 */
final class Version20191206182652 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_answer ADD comment VARCHAR(500) DEFAULT NULL, CHANGE fk_choice_id fk_choice_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_answer DROP comment, CHANGE fk_choice_id fk_choice_id INT DEFAULT NULL');
    }
}
